...
public enum SkillEnum {
	DENTAL_CLAIM("Dental Claim","Dental Claim",2), VISION_CLAIM("Vision Claim","Vision Claim",1), DATA_ENTRY("Data Entry","Data Entry",4),MEDICAL_REVIEW("Medical Review","Medical Review",3);
	private String name;
	private Integer id;
